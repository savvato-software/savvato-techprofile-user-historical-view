...
export class QuestionService {
  ...
  getLineItemLevelAssociations(questionId) {
    let url = this.environment.apiUrl + "/api/question/" + questionId + "/lineitem/levels";
  ...
  getAll() {
      let url = this.environment.apiUrl + "/api/question/all";
  ...
  getQuestionById(id) {
      let url = this.environment.apiUrl + "/api/question/" + id;
  ...
  getByLineItemAndLevel(lineItemId, levelIdx) {
      let url = this.environment.apiUrl + "/api/question/" + lineItemId + "/" + levelIdx;
	...
	getUserHistoryForQuestion(userId, questionId) {
      let url = this.environment.apiUrl + "/api/user/" + userId + "/question/" + questionId + "/history";
  ...
  save(question, lilvassociations) {
    let url = this.environment.apiUrl + "/api/question/save";
